        ...
        <CRow>
            <CCard>
                ...
                <CModal alignment="center" :visible="settingsModel" @close="() => { settingsModel = false }">
                    ...
                    <CModalFooter>
                        <CButton color="info" @click="resetPassword()" :disabled="buffer">
                            <CIcon name="cil-sync" /> Reset
                        </CButton>
                ...
                <CModal alignment="center" :visible="optionsModel" @close="() => { optionsModel = false }">
                    ...
                    <CModalBody>
                        <CFormCheck v-for="channel in item.bind" :key="channel.value" v-model="channel.checked"
                            :value="channel.value" :label="channel.label" />
                    </CModalBody>
                    <CModalFooter>
                        <CButton color="info" @click="updateBind()" :disabled="buffer">
